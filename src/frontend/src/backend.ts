...
export class Backend implements backendInterface {
    ...
    async getAllPredictions(): Promise<Array<PredictionEntry>> {
    ...
    async getComparableProperties(arg0: string, arg1: number): Promise<Array<ComparableProperty>> {
        if (this.processError) {
            try {
                const result = await this.actor.getComparableProperties(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPrediction(arg0: string): Promise<PredictionResult> {
        if (this.processError) {
            try {
    ...
    async predictPrice(arg0: HouseFeatures): Promise<PredictionResult> {
        if (this.processError) {
            try {
